...
import com.example.spring.entities.Payment;
...
import com.example.spring.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		OrderItem oi5 = new OrderItem(o1, p4, 2, p4.getPrice());
		...
		Payment pay2 = new Payment(null, Instant.parse("2019-07-22T17:21:22Z"), o1);
		o3.setPayment(pay1);		
		o1.setPayment(pay2);
